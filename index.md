...
*  Eating and drinking.
    ...
    - Notes.
        ...
        - [Jam](/food/jam.html).
*  Software.
    - [Games]({{ site.baseurl }}/category/software.html). Games I have written.
*  Interests.
...
* Nostalgia. For those who miss the old website.
    - [Download]({{ site.baseurl }}/category/olddownloads.html). Try some of the old software I have developed.
    - [Outdoors]({{ site.baseurl }}/category/outdoors.html). Explore the outdoors (in my footsteps).
